    ...
    <aside className={`admin-sidebar auditor-sidebar ${isSidebarOpen ? 'open' : 'collapsed'}`} style={{ backgroundColor: '#888B8D' }}>
      ...
      <div className="admin-profile-section">
        ...
        <div className="profile-info">
          ...
          <button 
            onClick={() => navigate('/logs/auditora/institucional')}
            ...
            <div className="box-container" style={{ padding: '8px 20px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {historialCartografia.map((capa, i) => (
                  <div key={i} onClick={() => onSelectCapa(capa)} style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', padding: '6px 8px', borderRadius: '4px', background: capaActiva === capa ? 'rgba(255, 255, 255, 0.1)' : 'transparent' }}>
            ...
            <div className="box-container" style={{ padding: '8px 20px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {historialInstrumentos.map((inst, i) => (
                  <div key={i} onClick={() => onSelectCapa(inst)} style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', padding: '6px 8px', borderRadius: '4px', background: capaActiva === inst ? 'rgba(255, 255, 255, 0.1)' : 'transparent' }}>
